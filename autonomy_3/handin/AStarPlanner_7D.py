...
class AStarPlanner_7D(object):
    ...
    def Plan(self, start_config, goal_config):
        ...
        def getCost(prev_g, prev_id, curr_id, goal_id):
            ...
            g = self.planning_env.ComputeDistance(prev_config, curr_config)
            h = self.planning_env.ComputeHeuristicCost(prev_config, curr_config)
        ...
        while heap:
            ...
            h = self.planning_env.ComputeHeuristicCost(curr_config, goal_config)
            g = curr_cost - h
            if self.planning_env.ComputeDistance(curr_config,goal_config) < 1:
