...
if __name__ == "__main__":
    ...
    # print footprint
    # for idx in range(len(base_env.actions)):
    #     base_env.PlotActionFootprints(idx)

    raw_input('Move robot to start config and press enter')
    sid = base_env.discrete_env.ConfigurationToNodeId(herb_base.GetCurrentConfiguration()+2)
    ...
    gid = base_env.discrete_env.ConfigurationToNodeId(herb_base.GetCurrentConfiguration()-3)
