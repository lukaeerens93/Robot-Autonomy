...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--robot', type=str, default='herb',
                        help='The robot to load (herb or simple)')
    parser.add_argument('-p', '--planner', type=str, default='rrtconnect',
